...
(function() {
  var IAPVerifier, http, https, url;
  ...
  IAPVerifier = (function() {
    ...
    function IAPVerifier(password, production, debug, timeout) {
      ...
      this.host = this.host || (this.production ? this.productionHost : this.sandboxHost);
      this.port = 443;
    ...
    IAPVerifier.prototype.verify = function(data, options, cb) {
      var client, parts, post_data, request;
      if (this.debug) {
        console.log("verify!");
      }
      options.headers = {
      ...
      if (this.stubUrl) {
        client = http;
        parts = url.parse(this.stubUrl);
        options.port = parts.port;
        options.host = parts.hostname;
        options.headers['Content-Type'] = 'application/json';
        data = Object.assign(data, this.stubBody);
      } else {
        client = https;
      }
      post_data = JSON.stringify(data);
      options.headers['Content-Length'] = post_data.length;
      request = client.request(options, (function(_this) {
